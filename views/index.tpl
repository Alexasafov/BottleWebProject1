...
<form action="/home" method="post">
    <p><p><input type="text" size="50" name="USERNAME" placeholder="Your name"></p>
        <p><textarea style="resize: none;" rows="2" cols="50" name="QUEST" 
                     placeholder="Your question"></textarea></p> 
